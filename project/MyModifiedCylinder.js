...
export class MyModifiedCylinder extends CGFobject {
    constructor(scene, slices, slicesPerTextureRepetition) {
        super(scene);
        this.slices = slices;
        this.slicesPerTex = slicesPerTextureRepetition;
        this.initBuffers();
    }
    ...
    initBuffers(){
        ...
        var xTexCoord = 0;
        var deltaTexCoord = this.slicesPerTex/(this.slices);
        var currentSlice = 0;
        ...
        for(var i = 0; i < this.slices; i++){
            ...
            if(currentSlice >= this.slicesPerTex){
                xTexCoord = 0;
                currentSlice = 0;
            } else {
                currentSlice++;
